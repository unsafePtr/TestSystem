...
{
    public class TestSystemService : ITestSystemService, IDisposable
    {
        ...
        /// <returns>Returns userTestId</returns>
        ...
        /// <summary>
        /// Starts tests. If the supplied userTestId is incorrect or test is already started throws exception
        /// </summary>
        /// <param name="userTestId"></param>
        /// <returns></returns>
        ...
        private void ThrowIfTestIsInvalid(TestDto test)
        {
        ...
        private void ThrowIfQuestionIsInvalid(QuestionDto question)
        {
            if(question.QuestionTypeId == QuestionTypeEnum.Closed)
            {
        ...
        private void ThrowIfUserTestEntityIsInvalid(UserTestDto userTest)
        {
        ...
        private async Task ThrowIfTestAssignedToUserAsync(Test test)
        {
